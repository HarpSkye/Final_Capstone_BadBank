set -gx CONDA_EXE (cygpath "C:\bld\conda_1565126647711\_h_env\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "C:\bld\conda_1565126647711\_h_env")
set _CONDA_EXE (cygpath "C:\bld\conda_1565126647711\_h_env\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "C:\bld\conda_1565126647711\_h_env\python.exe")
